function fun() {
    ...
    document.getElementById('o1').innerHTML = "Loan Amount: ₹"+
    Math.ceil(LoanAmount);
    document.getElementById('o2').innerHTML = "Total Interest: ₹"+
    Math.ceil(TotalInterest);
    document.getElementById('o3').innerHTML = "EMI: ₹" + Math.floor(EMI);
    document.getElementById('o4').innerHTML = "Total Repayment: ₹" +
    Math.ceil(TR);
    }